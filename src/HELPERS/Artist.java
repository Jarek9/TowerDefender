...
public class Artist {
	...
	public static final int WIDTH = 23 * TILE_SIZE, HEIGHT = 15 * TILE_SIZE;
	...
	public static void DrawQuad(float x, float y, float width, float height){
		...
		glBegin(GL_QUADS);
		glVertex2f(x, y); // lewy górny róg kwadratu
		glVertex2f(x + width, y); // prawy górny róg kwadratu
		glVertex2f(x + width, y + height); // lewy dolny róg kwadratu
		glVertex2f(x, y + height); // prawy dolny róg kwadratu
		glEnd();
